...
Tags: environment, bravenewcode, voteearth, earthhour, earth, hour, earthhour2012, duanestorey, dalemugford
...
During Earth Hour (which starts at 8:30pm local time on Saturday, March 28th, 2015), your blog will show a message of support for the initiative, along with every other WordPress site utilizing this plugin.
...
* Changed: WordPress compat. information
...
* Ready for 2011!
* Please re-submit updated translations via http://www.bravenewcode.com/contact/

= Version 1.3.2 =

* Added support link in admin
* Revised out-dated text in readme
...
* Added Greek translation (thanks to Cristos Sinopoulos)
...
* Removed padding from style sheet (causes a few glitches on centered blogs)

= Version 1.1.7 =

* Fixed text domain problem on numbers

= Version 1.1.6 =

* Fixed style issues in some situations regarding the banner
* Added Russian translation (Thanks to Kirill A Kolpakov)
...
* Fixed bug with regards to when Earth Hour starts in other time zones
...
* Sure! We've included the .POT file in the download package.  Please translate it to the language of your choice and upload it using the POT file contact form at http://www.bravenewcode.com/contact

= Why Doesn't The Banner Show Up On My Site? =

* It's most likely because your theme doesn't have a wp_footer template tag.  Try adding that to your theme. If you still have issues with Earth Hour visit http://www.bravenewcode.com/support/ for more help.

== Screenshots ==

1. Earth Hour Preview (what your site would look like during Earth Hour)
2. Website with Banner bar at the top (shows countdown to Earth hour)
